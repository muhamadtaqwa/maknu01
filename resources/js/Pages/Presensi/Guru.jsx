...
export default function Guru() {
    ...
    const handleScan = (guruIdTerbaca) => {
        setSending(true);
        router.post(
            "/presensi-guru",
            { guru_id: guruIdTerbaca },
            {
                onSuccess: () => {
                    playBeep();
                ...
                onError: (errors) => {
                    toast.error(
                        errors?.error || "Presensi gagal atau sudah lengkap.",
                    );
                    setGuruId("");
                    setSending(false);
                },
    ...
    return (
        <AppLayout>
            <div>
                ...
                {/* Input manual ID Guru - hanya admin & harian */}
                {isAdmin && activeMode === "harian" && (
                    <div className="rounded-[30px] border border-teal-100 bg-white p-4 shadow-2xl mb-4">
                        <div className="flex gap-2">
                            ...
                            />
                            <button
                                onClick={() => handleScan(guruId)}
                                disabled={!guruId || sending}
