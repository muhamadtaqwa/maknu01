                        ...
                        >
                            <div className="flex items-center justify-between mb-2">
                                <div className="flex items-center gap-2">
                                    ...
                                    >
                                        {siswa.status?.charAt(0).toUpperCase() +
                                            siswa.status?.slice(1)}
                                    </span>
                                </div>
                                {isAdmin && (
                            ...
                            <div className="text-[11px] text-slate-500 space-y-0.5">
                                ...
                                {(siswa.tempat_lahir ||
                                    ...
                                    <Row
                                        label="TTL"
                                        value={`${siswa.tempat_lahir || "-"}, ${formatTgl(siswa.tanggal_lahir) || "-"}`}
                                    />
                                )}
                                {siswa.jenis_kelamin && (
                                    <Row
                ...
                {siswas.last_page > 1 && (
                    <div className="flex items-center justify-between mt-4">
                        ...
                        <span className="text-xs text-slate-400">
                            Halaman {siswas.current_page} dari{" "}
                            {siswas.last_page}
                        </span>
                        <button
                            onClick={() =>
                                router.get(
                                    siswas.next_page_url,
                                    {},
                                    { preserveState: true },
                                )
                            }
